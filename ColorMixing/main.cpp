...
void RenderColorPickerView() {
	...
	//draw circle on selected colors
	float radius = 5.0;
	int lineAmount = 100;
...
void RenderCustomBlendView() {
	...
	HuePreservingBlend(r1, g1, b1, r4, g4, b4, r3, g3, b3);

	// mixture of 4 6
	GLfloat r5 = 0; GLfloat g5 = 0; GLfloat b5 = 0;
	HuePreservingBlend(r4, g4, b4, r6, g6, b6, r5, g5, b5);

	// mixture of 1 6
	GLfloat r7 = 0; GLfloat g7 = 0; GLfloat b7 = 0;
	HuePreservingBlend(r1, g1, b1, r6, g6, b6, r7, g7, b7);
